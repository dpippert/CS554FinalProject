...
db.questions.insertMany(
  [
   ...
   {"_id": new ObjectId().str,
    ...
    "a": ["Array", "Arrays"]},
     ...
     {"_id": new ObjectId().str,
      "t": "API",
     "u": null,
     "q": "Full form of API is",
     "a": ["Application programming interface"]},

    {"_id": new ObjectId().str,
     "t": "API",
     "u": null,
     "q": " Which of the following HTTP method should be used to get status of method availability in RESTful web service?",
     "a": ["HEAD"]},
    ...
    {"_id": new ObjectId().str,
     "t": "API",
     "u": null,
     "q": "What is the Category of the 1XX HTTP Codes belongs to?",
     "a": ["infomational", "information"]},
   ...
   {"_id": new ObjectId().str,
    "t": "Computer Basics",
    "u": null,
    "q": "Another namme for supercomputer is",
    "a": ["monster computer","monster"]},

   {"_id": new ObjectId().str,
    "t": "Computer Basics",
    "u": null,
    "q": "This computer is a multiprocessing computer system that is smaller and slower than a mainframe",
    "a": ["Minicomputer"]},

   {"_id": new ObjectId().str,
    "t": "Computer Basics",
    "u": null,
    "q": "This computer is mainly used in homes for recreation",
    "a": ["Personal Computer"]},

   {"_id": new ObjectId().str,
    "t": "Computer Basics",
    "u": null,
    "q": "Complex scientific research is usually done using:",
    "a": ["Super computer"]},

   {"_id": new ObjectId().str,
    "t": "Computer Basics",
    "u": null,
    "q": "true/False:A laptop is an example of a personal computer.",
    "a": ["TRUE"]} 
    ]);
